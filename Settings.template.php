...
function template_settings()
{
	...
	$context['theme_settings'] = array(
		...
		array( 
            'id' => 'sh_custcontent_below',
            'label' => $txt['sh_custcontent_below'],
            'description' => $txt['sh_custcontent_below_desc']. '. '. $txt['sh_copy_own_desc'],
            'type' => 'textarea',
        ),
		array(
			'id' => 'sh_allow_color_change',
			'label' => $txt['sh_allow_color_change'],
			'default' => true,
		),
        array(
			'id' => 'sh_variant_icons',
			'label' => $txt['sh_variant_icons'],
			'description' => $txt['sh_variant_icons_desc'],
			'default' => false,
		),
		array(
		...
		array(
			'id' => 'board_lastpost_stats',
			'label' => $txt['board_lastpost_stats'],
			'type' => 'checkbox',
			'default' => true,
			),
		'',
